package com.example.tp1_sharedpreferencesmvvm.ui.login;
...
import com.example.tp1_sharedpreferencesmvvm.request.ApiClient;
import com.example.tp1_sharedpreferencesmvvm.ui.registro.RegistroActivity;
        ...
        if(usuario==null)
        {
            ...
            tiempoPaInicia.schedule(new TimerTask() {
                ...
                public void run() {
                    ...
                    //Intent intent= new Intent(getApplication(), RegistroActivity.class);
                    //intent.putExtra("ema", usuario.getEmail());
                    //intent.putExtra("pass", usuario.getContrasena());
                    //intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    //getApplication().startActivity(intent);
                }
            },2000);
